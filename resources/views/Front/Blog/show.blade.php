...
<!-- Start top-section Area -->
      ...
      <div class="container">
          <div class="row justify-content-between align-items-center d-flex">
              <div class="col-lg-8 top-left">
                  <h1 class="text-uppercase text-white mb-20">Blog Single</h1>
                  <p class="text-white">
                      Having used discount toner cartridges for twenty years, there have been a lot of changes in the toner cartridge market.
                  </p>
              </div>
  ...
  <section class="blog-posts-area pt-120">
      <div class="container">
          <div class="row">
              <div class="col-lg-8 post-list">
                  <div class="single-post">
                      <img class="img-fluid" src="img/elements/blog/p1.jpg" alt="">
                      <div class="row align-items-center mt-20 mb-20">
                          <ul class="tags col-lg-6 col-md-6">
                              <li><a href="#">Art</a></li>
                              <li><a href="#">Technology</a></li>
                              <li><a href="#">Fashion</a></li>
                          </ul>
                          <div class="comment-wrap col-lg-6 col-md-6">
                              <ul>
                      ...
                      <div class="bottom-meta">
                          <div class="user-details row align-items-top">
                              <div class="user-details d-flex flex-row col">
                                  <div class="thumb"><img src="img/elements/blog/user.jpg" alt=""></div>
                                  <div class="title">
                                      <a href="#"><h6>Mark wiens</h6></a>
                                      <p>12 Dec 2018 11:21 pm</p>
                                  </div>
                              </div>
                          </div>
                      </div>
                      ...
                      <div class="row align-items-center pb-20 single-page-social-wrap">
                          <div class="col">
                          </div>
                      ...
                      <section class="nav-area pt-50 pb-50">
                          <div class="container">
                              <div class="row justify-content-between">
                                  <div class="col-sm-6 nav-left justify-content-start d-flex no-padding">
                                      <div class="thumb">
                                          <img src="img/elements/blog/prev.jpg" alt="">
                                      </div>
                                      <div class="details">
                                          <p>Prev Post</p>
                                  ...
                                  <div class="col-sm-6 nav-right justify-content-end d-flex no-padding">
                                      <div class="details">
                                          <p>Prev Post</p>
                                          <h4><a href="#">A Discount Toner</a></h4>
                                      </div>
                                      <div class="thumb">
                                          <img src="img/elements/blog/next.jpg" alt="">
                                      </div>
                                  </div>
                              </div>
                          </div>
                              ...
                              <div class="row flex-column">
                                  ...
                                  <div class="comment-list">
                                      <div class="single-comment justify-content-between d-flex">
                                          <div class="user justify-content-between d-flex">
                                              <div class="thumb">
                                                  <img src="img/elements/blog/c1.jpg" alt="">
                                              </div>
                                              <div class="desc">
                                  ...
                                  <div class="comment-list left-padding">
                                      <div class="single-comment justify-content-between d-flex">
                                          <div class="user justify-content-between d-flex">
                                              <div class="thumb">
                                                  <img src="img/elements/blog/c2.jpg" alt="">
                                              </div>
                                              <div class="desc">
                                                  <h5><a href="#">Emilly Blunt</a></h5>
                                                  <p class="date">December 4, 2017 at 3:12 pm </p>
                                  ...
                                  <div class="comment-list left-padding">
                                      <div class="single-comment justify-content-between d-flex">
                                          <div class="user justify-content-between d-flex">
                                              <div class="thumb">
                                                  <img src="img/elements/blog/c3.jpg" alt="">
                                              </div>
                                              <div class="desc">
                                                  <h5><a href="#">Emilly Blunt</a></h5>
                                                  <p class="date">December 4, 2017 at 3:12 pm </p>
                                  ...
                                  <div class="comment-list">
                                      <div class="single-comment justify-content-between d-flex">
                                          <div class="user justify-content-between d-flex">
                                              <div class="thumb">
                                                  <img src="img/elements/blog/c4.jpg" alt="">
                                              </div>
                                              <div class="desc">
                                                  <h5><a href="#">Emilly Blunt</a></h5>
                                                  <p class="date">December 4, 2017 at 3:12 pm </p>
                                  ...
                                  <div class="comment-list">
                                      <div class="single-comment justify-content-between d-flex">
                                          <div class="user justify-content-between d-flex">
                                              <div class="thumb">
                                                  <img src="img/elements/blog/c5.jpg" alt="">
                                              </div>
                                              <div class="desc">
                                                  <h5><a href="#">Emilly Blunt</a></h5>
                                                  <p class="date">December 4, 2017 at 3:12 pm </p>
                      ...
                      <section class="commentform-area pt-80 pb-120">
                          <div class="container no-padding">
                              ...
                              <div class="row flex-row d-flex">
                                  ...
                                  <div class="col-lg-6">
                                      ...
                                      <a class="genric-btn primary mt-20" href="#">Comment</a>
                                  </div>
                              </div>
                          </div>
                      </section>
              ...
              <div class="col-lg-4 sidebar pb-120">
                  ...
                  <div class="single-widget protfolio-widget">
                      <img src="img/elements/blog/user2.jpg" alt="">
                      ...
                      <div class="blog-list">
                          <div class="single-blog relative">
                              <a href="#">
                                  <div class="thumb">
                                      ...
                                      <img class="img-fluid" src="img/elements/blog/r1.jpg" alt="">
                                  </div>
                                  <div class="details">
                                      <h4>Home Audio Recording
                                  For Everyone</h4>
                          ...
                          <div class="single-blog relative">
                              <a href="#">
                                  <div class="thumb">
                                      <div class="overlay overlay-bg"></div>
                                      <img class="img-fluid" src="img/elements/blog/r2.jpg" alt="">
                                  </div>
                                  <div class="details">
                                      <h4>Home Audio Recording
                                  For Everyone</h4>
                          ...
                          <div class="single-blog relative">
                              <a href="#">
                                  <div class="thumb">
                                      <div class="overlay overlay-bg"></div>
                                      <img class="img-fluid" src="img/elements/blog/r3.jpg" alt="">
                                  </div>
                                  <div class="details">
                                      <h4>Home Audio Recording
                                  For Everyone</h4>
                          ...
                          <div class="single-blog relative">
                              <a href="#">
                                  <div class="thumb">
                                      <div class="overlay overlay-bg"></div>
                                      <img class="img-fluid" src="img/elements/blog/r4.jpg" alt="">
                                  </div>
                                  <div class="details">
                                      <h4>Home Audio Recording
                                  For Everyone</h4>
